...
app.get('/', (req, res) => {
    res.render('index', { loggedIn: false,
        ...
        categories: [{name:"type", show:false, items:["All", "cards", "board games", "video games", "memorabilia"]},
        {name:"price", show:false, items:["All", "<$20", "<$50", "<$200", "<$100", "<$250", "<$1000"]},
        {name:"distance", show:false, items:["All", "<1km", "<3km", "<5km","<10km","<25km","<50km","<100km"]}]
    });
});
